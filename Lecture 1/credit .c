...
int main(void)
{
    ...
    // Check bank
    // By first two/one digits and total digits
...
int even_digit(int n)
{
    ...
    if (product >= 10)
    {
        for (int i = 0; i < 2; i++)
        {
            // Split two-digits number into two single-digit numbers
            // e.g. 18 -> 1, 8
            // Product max is 18, so there are two and only two rounds
